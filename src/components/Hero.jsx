        ...
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6` }>
                ...
                <p className={`${styles.paragraph}`}>
                    <span className="text-white>20%">20%</span> Discount For {" "}
            ...
            <div className={`flex-1 flex ${styles.flexCenter} md:my-10 relative`}>
                <img src={robot} alt="billig" className="w-full h-full relative z-[5]" />
                <div className="absolute z-0 w-[40%] h-[35%] top-0 pink__gradient"/>
                <div className="absolute z-1 w-[80%] h-[80%] top-0 bottom-40  rounded-full white__gradient"/>
                <div className="absolute z-0 w-[50%] h-[55%] right-0 bottom-20 blue__gradient"/>
            </div>
